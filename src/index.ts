...
export const YUBINBANGO_PREFECTURE = [
  ...
  { value: '8', id: 'tokyo', label: '東京都' },
  { value: '9', id: 'kanagawa', label: '神奈川県' },
  { value: '10', id: 'chiba', label: '千葉県' },
  { value: '11', id: 'saitama', label: '埼玉県' },
  { value: '12', id: 'gunma', label: '群馬県' },
  { value: '13', id: 'tochigi', label: '栃木県' },
  { value: '14', id: 'ibaraki', label: '茨城県' },
  { value: '15', id: 'yamanashi', label: '山梨県' },
  { value: '16', id: 'nagano', label: '長野県' },
  { value: '17', id: 'gifu', label: '岐阜県' },
  { value: '18', id: 'shizuoka', label: '静岡県' },
  { value: '19', id: 'aichi', label: '愛知県' },
  { value: '20', id: 'mie', label: '三重県' },
  { value: '21', id: 'shiga', label: '滋賀県' },
  { value: '22', id: 'kyoto', label: '京都府' },
  { value: '23', label: '大阪府' },
  { value: '24', id: 'hyogo', label: '兵庫県' },
  { value: '25', id: 'nara', label: '奈良県' },
  { value: '26', id: 'wakayama', label: '和歌山県' },
  { value: '27', id: 'tottori', label: '鳥取県' },
  { value: '28', id: 'shimane', label: '島根県' },
  { value: '29', id: 'okayama', label: '岡山県' },
  { value: '30', id: 'hiroshima', label: '広島県' },
  { value: '31', id: 'yamaguchi', label: '山口県' },
  { value: '32', id: 'tokushima', label: '徳島県' },
  { value: '33', id: 'kagawa', label: '香川県' },
  { value: '34', id: 'ehime', label: '愛媛県' },
  { value: '35', id: 'kochi', label: '高知県' },
  { value: '36', id: 'fukuoka', label: '福岡県' },
  { value: '37', id: 'saga', label: '佐賀県' },
  { value: '38', id: 'nagasaki', label: '長崎県' },
  { value: '39', id: 'kumamoto', label: '熊本県' },
  { value: '40', id: 'oita', label: '大分県' },
  { value: '41', id: 'miyazaki', label: '宮崎県' },
  { value: '42', id: 'kagoshima', label: '鹿児島県' },
  { value: '43', id: 'okinawa', label: '沖縄県' },
];
